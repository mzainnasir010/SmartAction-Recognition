...
class CNNLSTMModel(nn.Module):
    ...
    - CNN: ResNet50 (weights loaded from trained checkpoint, frozen)
    ...
    def __init__(self, num_classes, lstm_hidden=256, lstm_layers=2, dropout=0.3):
        ...
        # ResNet50 backbone - no pretrained ImageNet weights loaded here.
        # Trained weights come from the checkpoint via load_state_dict() at inference time,
        # so loading ImageNet weights first would just be wasted memory (immediately overwritten).
